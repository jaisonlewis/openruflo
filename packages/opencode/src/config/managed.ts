...
const MANAGED_PLIST_DOMAIN = "ai.openruflo.managed"
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    case "darwin":
      return "/Library/Application Support/openruflo"
    case "win32":
      return path.join(process.env.ProgramData || "C:\\ProgramData", "openruflo")
    default:
      return "/etc/openruflo"
  }
}
