...
const TIPS = [
  ...
  "Create {highlight}openruflo.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "openruflo auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "openruflo auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "openruflo uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent openruflo from reading sensitive files",
  "Use {highlight}openruflo run{/highlight} for non-interactive scripting",
  "Use {highlight}openruflo --continue{/highlight} to resume the last session",
  "Use {highlight}openruflo run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}openruflo serve{/highlight} for headless API access",
  "Use {highlight}openruflo run --attach{/highlight} to connect to a running server",
  "Run {highlight}openruflo upgrade{/highlight} to update to the latest version",
  "Run {highlight}openruflo auth list{/highlight} to see all configured providers",
  "Run {highlight}openruflo agent create{/highlight} for guided agent creation",
  "Use {highlight}/openruflo{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}openruflo github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/openruflo fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}openruflo debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/jaisonlewis/openruflo{/highlight} for containerized use",
  ...
  // openruflo workflow tips
  "Run {highlight}/ruflo{/highlight} to build from a plan using parallel sub-agents",
  "Use {highlight}/standup{/highlight} to generate today's standup from memory and tasks",
  "Run {highlight}/wrap-up{/highlight} to file decisions, wins, and snapshot context",
  "Use {highlight}/dump{/highlight} to brain-dump loose thoughts — they get classified and stored",
  "Run {highlight}/brag{/highlight} to generate a Brag Doc entry for performance reviews",
  "Use {highlight}/decide{/highlight} to record architectural decisions with rationale",
  "Run {highlight}/retro{/highlight} for a sprint retrospective from memory",
  "Sub-agents inherit your selected model automatically — or pass {highlight}model={/highlight} to override",
  "Run {highlight}ruflo memory init{/highlight} in your project to enable persistent session memory",
  "openruflo auto-starts sentrux for architecture quality gates on every session",
